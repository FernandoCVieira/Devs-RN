                ...
                <div class="row">
                    ...
                    <div class="col-md-9 mt-5">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <h3 class="text-dark font-weight-bold">Cadastrar Anuidades</h4>
                                    <hr>
                                    <form action="app/cadastrar-anuidades.php" method="POST">
                                        <div class="form-group">
                                            <label for="ano" class="form-label font-weight-bold">Ano</label>
                                            <input type="number" name="ano" class="form-control" id="anuData">
                                        </div>
                                        <div class="form-group">
                                            <label for="valor" class="form-label font-weight-bold">Valor</label>
                                            <input type="number" name="valor" class="form-control" id="anuValor">
                                        </div>
